...
@objc final public class GalleryViewController : UIPageViewController, UIViewControllerTransitioningDelegate, ImageViewControllerDelegate  {
    ...
    /// TRANSITIONS
    private var presentTransition: GalleryPresentTransition?
    private var closeTransition: GalleryCloseTransition?
    ...
    // MARK: - VC Setup
    public func setImageProvider(imageProvider : ImageProvider){
    self.imageProvider = imageProvider
    }
    
    public func setDisplacedView(displacedView : UIView){
        self.displacedView = displacedView
    }
    
    public func setImageCount(imageCount: Int){
        self.imageCount = imageCount
    }
    
    public func setStartIndex(startIndex : Int){
...
//        configuration: GalleryConfiguration = defaultGalleryConfiguration()
        
        self.configuration = defaultGalleryConfiguration()
    ...
    func closeWithAnimation(completion: (() -> Void)?) {
        ...
        UIView.animateWithDuration(0.1, animations: { [weak self] in
            ...
            if self?.currentIndex == self?.startIndex {
                ...
                if let imageController = self?.viewControllers?.first as? GalleryImageViewController {
    ...
    func imageViewController(controller: GalleryImageViewController, didSwipeToDismissWithDistanceToEdge distance: CGFloat) {
    ...
    func imageViewControllerDidSingleTap(controller: GalleryImageViewController) {
    ...
    func imageViewControllerDidAppear(controller: GalleryImageViewController) {
